module.exports = {
	...
	switch_onlyM_from_D: function(idx){
		...
		if (31 < idx && idx <= 31+28)
			return 2;
		if (31+28 < idx && idx <= 31+28+31)
			return 3;
		if (31+28+31 < idx && idx <= 31+28+31+30)
			return 4;
		if (31+28+31+30 < idx && idx <= 31+28+31+30+31)
			return 5;
		if (31+28+31+30+31 < idx && idx <= 31+28+31+30+31+30)
			return 6;
		if (31+28+31+30+31+30 < idx && idx <= 31+28+31+30+31+30+31)
			return 7;
		if (31+28+31+30+31+30+31 < idx && idx <= 31+28+31+30+31+30+31+31)
			return 8;
		if (31+28+31+30+31+30+31+31 < idx && idx <= 31+28+31+30+31+30+31+31+30)
			return 9;
		if (31+28+31+30+31+30+31+31+30 < idx && idx <= 31+28+31+30+31+30+31+31+30+31)
			return 10;
		if (31+28+31+30+31+30+31+31+30+31 < idx && idx <= 31+28+31+30+31+30+31+31+30+31+30)
			return 11;
		if (31+28+31+30+31+30+31+31+30+31+30 < idx && idx <= 31+28+31+30+31+30+31+31+30+31+30+31)
			return 12;
	},
